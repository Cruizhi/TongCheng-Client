...
public class RegionUtils extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regionutil);
    ...
    private void initClick() {
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                + et_detailAddress.getText().toString());
    ...
    private void initView() {
        spinner_sheng = (Spinner) findViewById(R.id.sp_region_province);
        spinner_shi = (Spinner) findViewById(R.id.sp_region_city);
        spinner_qu = (Spinner) findViewById(R.id.sp_region_area);
        et_detailAddress = (EditText) findViewById(R.id.et_region_address);
        btn_confirm = (Button) findViewById(R.id.btn_region_submit);
    }
